...
# Or, if that doesn't work, from our github page:
if(!exists("df.read")) {
  readr::read_csv("https://raw.githubusercontent.com/Living-Data-Tutorials/website/main/_lessons/2022-08-26-species-richness-rank-abundance-curves/Data/TLW_invertebrateDensity.csv")
} 
...
The catchment that was logged with medium intensity also appears to have a less "even" rank-abundance curve compared to the other two.
