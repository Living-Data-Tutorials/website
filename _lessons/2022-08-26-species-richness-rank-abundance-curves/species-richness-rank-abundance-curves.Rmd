...
In this tutorial, we have explained the meaning of different biodiversity metrics, introduced rank-abundance curves and what they can tell you about a community and differences between communities, and showed you how to calculate these metrics using the `codyn` package in R.
